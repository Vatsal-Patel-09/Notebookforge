...
export default function Home() {
  ...
  const [labInfo, setLabInfo] = useState({
    ...
    footerCenter: { type: "empty" as ContentType, customText: "", pageFormat: "plain" as PageNumberFormat }, // Changed from page_number to empty temporarily
  ...
  const contentTypeOptions = [
    ...
    // { value: "page_number", label: "Page Number" }, // Temporarily disabled - page number functionality needs fixing
  ...
  const renderFieldControls = (
    ...
    <div className="space-y-3">
      ...
      {/* Temporarily disabled page number format selection - functionality needs fixing
                ...
                <Button
                  ...
                  onClick={() =>
                    setLabInfo((prev) => ({
                      ...
                      footerCenter: { type: "empty", customText: "", pageFormat: "page_word" }, // Changed from page_number to empty temporarily
                ...
                <Button
                  ...
                  onClick={() =>
                    setLabInfo((prev) => ({
                      ...
                      footerCenter: { type: "empty", customText: "", pageFormat: "fraction" }, // Changed from page_number to empty temporarily
                      footerRight: {
                        type: "custom",
                ...
                <Button
                  ...
                  onClick={() =>
                    setLabInfo((prev) => ({
                      ...
                      footerCenter: { type: "empty", customText: "", pageFormat: "plain" }, // Changed from page_number to empty temporarily
