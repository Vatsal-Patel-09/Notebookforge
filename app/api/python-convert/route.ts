...
export async function POST(request: NextRequest) {
  try {
    ...
    const labTitle = lab_info?.labTitle || "NotebookForge .ipynb to Word converter"
    ...
    const generateFieldContent = (field: any, filename: string, labTitle: string): TextRun[] => {
